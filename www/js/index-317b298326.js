...
/***/ function(module, exports, __webpack_require__) {
	...
	var wx = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	    ...
	    $.post('/api/skill',{},function(response){
	        ...
	        // $('#thelist').append($(li))；
	         ...
	         $('#swiper-container').hide();
	          var iScroll = __webpack_require__(9);
